 ...
 * Runs the step definition's callback and provides the target, application and any captures to it
 */
Kraut.executeStepDefinition = function( stepDefinition, title, captures ) {
    
    try {
    
        stepDefinition.callback( Kraut.target, Kraut.application, captures );
