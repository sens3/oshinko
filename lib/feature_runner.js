 ...
 */
Oshinko.run = function ( ) {
        
    var featureFiles = Oshinko.bash.ls( Oshinko.featureDirectory );

    featureFiles.forEach( function ( featureFile) {
        
        var featurePath = Oshinko.featureDirectory + '/' + featureFile;
        var featureText = Oshinko.bash.cat( featurePath );
