...
Oshinko.init = function ( options ) {
    ...
    Oshinko.featureDirectory = options.featureDir
 ...
 */
Oshinko.runAll = function () {
  
  if (Oshinko.featureDirectory == undefined)
    throw "Oshinko.featureDirectory must be set.";
  
  featureFiles = Oshinko.bash.ls( Oshinko.featureDirectory );
  
  featureFiles.forEach( function ( featureFilename ) {
      
      var featureFile = Oshinko.featureDirectory + '/' + featureFilename;
...
Oshinko.parseAndRunFeature = function ( feature ) {
    ...
    lines.forEach(function ( line ) {
        ...
        var featureStartMatch = line.match( Oshinko.featureRegex )
...
Oshinko.findAndExecuteStepDefinition = function( step ) {
    ...
    Oshinko.stepDefinitions.forEach( function ( stepDefinition ) {
